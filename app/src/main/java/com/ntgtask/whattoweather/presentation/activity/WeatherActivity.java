package com.ntgtask.whattoweather.presentation.activity;
...
import com.ntgtask.whattoweather.R;
import com.ntgtask.whattoweather.data.entities.WeatherResponse;
import com.ntgtask.whattoweather.presentation.presenter.WeatherPresenter;
...
public class WeatherActivity extends AppCompatActivity implements IWeatherView {
    ...
    @Override
    public void onDataFetched(WeatherResponse response) {
